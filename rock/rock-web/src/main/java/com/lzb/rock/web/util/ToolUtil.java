...
public class ToolUtil {
	...
	public static String getRandomString(int length) {
		...
		return UtilString.getRandomString(length);
	}
	...
	public static String dateType(Object o) {
		if (o instanceof Date) {
			return UtilDate.getFomtDateByDate("yyyy-MM-dd", (Date) o);
		} else {
			return o.toString();
		}
	}
	 ...
	 * @Date 2017/4/18 12:55
	 */
	public static String dateType(Object o, String fomt) {
		if (UtilString.isBlank(fomt)) {
			fomt = "yyyy-MM-dd";
		}

		if (o instanceof Date) {
			return UtilDate.getFomtDateByDate(fomt, (Date) o);
		} else {
			return o.toString();
		}
	}
	...
	public static String getExceptionMsg(Exception e) {
		return UtilExceptionStackTrace.getStackTrace(e);
	}
	...
	public static boolean isEmpty(Object o) {
		...
		if (o instanceof String) {
			if (UtilString.isBlank(o.toString())) {
				return true;
			}
	...
	public static String format(String template, Object... values) {
		return UtilString.format(template, values);
	}
	...
	public static String format(String template, Map<?, ?> map) {
		return UtilString.format(template, map);
	}
...
//	}
	...
	public static String currentTime() {
		return UtilDate.getFomtDateByThisTime("yyyy-MM-dd HH:mm:ss");
	}
	...
	public static String firstLetterToUpper(String val) {
		return UtilString.firstCharToUpperCase(val);
	}
	...
	public static String firstLetterToLower(String val) {
		return UtilString.firstCharToLowerCase(val);
	}
